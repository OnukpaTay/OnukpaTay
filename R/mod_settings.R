...
mod_settings_ui <- function(id) {
  ...
  bslib::layout_columns(
    col_widths = c(6, 6),
    bslib::card(
      bslib::card_header(bsicons::bs_icon("building"), " Practice details"),
      textInput(ns("practice_name"), "Practice / firm name",
                value = DEFAULT_SETTINGS$practice_name),
      textInput(ns("practice_addr"), "Address", value = DEFAULT_SETTINGS$practice_addr),
      textInput(ns("qs_name"), "Lead Quantity Surveyor", value = DEFAULT_SETTINGS$qs_name),
